        ...
        switch (fieldName) {
            ...
            case "name":
                validation[fieldName] = {
                    ...
                    message: (typeof value === 'string' ? value : '').trim().length >= 2 ? "" : "Name must be at least 2 characters long",
                };
                break;
            case "message":
                validation[fieldName] = {
                    isValid: (typeof value === 'string' ? value : '').trim().length >= 10,
                    message: (typeof value === 'string' ? value : '').trim().length >= 10 ? "" : "Message must be at least 10 characters long",
                };
                break;
            default:
