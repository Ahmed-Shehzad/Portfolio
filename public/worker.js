...
function processImageOptimization(data) {
    ...
    return images.map((image) => {
        ...
        return Object.assign(Object.assign({}, image), { IMAGE_OPTIMIZED_SIZES, estimatedSavings: calculateImageSavings(format, width, height), srcset: IMAGE_OPTIMIZED_SIZES.filter((size) => size.width <= width)
