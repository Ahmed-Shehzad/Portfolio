...
describe('HeroSection', () => {
  ...
  it('renders hero section with correct content', () => {
    ...
    expect(screen.getByText('I am a Full Stack Developer with a passion for building web applications and services.')).toBeInTheDocument();
  });
  ...
  it('renders optimized image with correct props', () => {
    ...
    expect(images[0]).toHaveAttribute('alt', 'Muhammad Ahmed Shehzad - Professional headshot of a full-stack developer');
  });
